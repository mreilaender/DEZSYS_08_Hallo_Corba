...
_CORBA_MODULE echoCor

_CORBA_MODULE_BEG

#ifndef __echoCor_mEcho__
#define __echoCor_mEcho__
  class Echo;
  class _objref_Echo;
  class _impl_Echo;
...
_CORBA_MODULE POA_echoCor
_CORBA_MODULE_BEG

  class Echo :
    public virtual echoCor::_impl_Echo,
    public virtual ::PortableServer::ServantBase
  {
  public:
    virtual ~Echo();

    inline ::echoCor::Echo_ptr _this() {
      return (::echoCor::Echo_ptr) _do_this(::echoCor::Echo::_PD_repoId);
    }
  };
...
inline void
echoCor::Echo::_marshalObjRef(::echoCor::Echo_ptr obj, cdrStream& s) {
